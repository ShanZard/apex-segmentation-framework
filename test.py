...
def main():
    ...
    parser.add_argument('--model-file', type=str, default='/root/root/DAdataset/BEAL111/logs/20220503_055658.205891/checkpoint_129.pth.tar',
                        help='Model path')
    parser.add_argument(
    ...
    # 2. model
    model = model=convnext_tiny()#create_model('DeepLabV3Plus',encoder_name='resnet34', encoder_depth=5, encoder_weights='imagenet', encoder_output_stride=16, decoder_channels=256, 
    #decoder_atrous_rates=(12, 24, 36), in_channels=3, classes=2, activation=None, upsampling=4, aux_params=None).cuda()
